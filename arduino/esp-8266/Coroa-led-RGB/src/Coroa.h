...
<body>
    ...
    <div class = "cores">      
        ...
        <button id = "verde-primavera">Verde Primavera</button>   
        <button id = "verde">Verde</button>  
        <button id = "lilas">Lilás</button>
        <button id = "azul-violeta">Azul Violeta</button>   
    ...
    <script>
        ...
        let btnVP = document.getElementById("verde-primavera");
        ...
        let btnBV = document.getElementById("azul-violeta");
